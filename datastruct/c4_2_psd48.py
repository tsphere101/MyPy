...
if __name__ == "__main__":
    ...
    for each in input_command:
        ...
        if command.upper() == "EN":
            queue_normal.enqueue(arg)
        elif command.upper() == "ES":
            queue_samruad.enqueue(arg)
        elif command.upper() == "D":
            if queue_normal.is_empty() and queue_samruad.is_empty():
                print("Empty")
            else:
                if not queue_samruad.is_empty():
                    print(queue_samruad.dequeue())
                else:
                    print(queue_normal.dequeue())
